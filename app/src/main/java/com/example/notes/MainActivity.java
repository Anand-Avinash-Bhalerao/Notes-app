...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //            Toast.makeText(MainActivity.this, "Sab kuch sahi se ho gaya", Toast.LENGTH_SHORT).show();
        ...
        noteAdapter.setOnIteClickListener(new NoteAdapter.OnItemClickListener() {
            @Override
